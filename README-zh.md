...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Zabbix 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://github.com/zabbix/docker#recommended-system-requirements)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| zabbix-web | 9006 | 浏览器访问 Zabbix | Y |
| zabbix-server | 10051 | TCP/api 访问Zabbix-server | Y |
| mysql | 3306 | TCP 访问MySQL数据库 | Y |
| zabbix-agent | 10050 | TCP/api 访问Zabbix-agent | Y |
## 文档

[Zabbix 管理员手册](https://support.websoft9.com/docs/zabbix)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Zabbix 企业级支持版](https://apps.websoft9.com/zabbix) 
