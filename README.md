...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r zabbix
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r zabbix -p
```
...
| --- | --- | --- | --- |
| zabbix-web | 9006 | Web-GUI database management tool | Y |
| zabbix-server | 10051 | Accessing zabbix-server database with TCP/api | Y |
| mysql | 3306 | Accessing MySQL database with TCP | Y |
| zabbix-agent | 10050 | Accessing zabbix-agent database with TCP/api | Y |
## Documentation

[Zabbix Administrator Guide](https://support.websoft9.com/docs/zabbix)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Zabbix Enterprise Support](https://apps.websoft9.com/zabbix) 
